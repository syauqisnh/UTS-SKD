...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-800">DESKRIPSI CAESAR & VIGENERE CIPHER</h1>
      				...
      				<div class="row">
      				  <div class="col-lg-12">
      				    <div class="p-5">
                            ...
                            <hr>
							        <div class="form-group">
								        <input id="username" type="number" name="input_key" class="form-control form-control-user" placeholder="key vigere" required>
							        </div>
								        <input type="submit" name="deskripsi_caesar" value="Deskripsi" class="btn btn-success btn-user">
							        <hr>
						        </form>
                                ...
                                <div class="my-2">
                                    <?php 
                                        ...
                                        if(isset($_POST['deskripsi_caesar'])){ //cek enkripsi
                                    		...
                                    		foreach ($chars as $char) { //perulangan untuk menampilkan data array
                                    			$output .= cipher($char, 26 - $kunci); //mengembalikan fungsi cipher
                                    		}
                                        
                                    		$chars_output = str_split($output); //variabel untuk menampung data yang dienkripsi untuk dienkripsikan
